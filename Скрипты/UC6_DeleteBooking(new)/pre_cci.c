# 1 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c"
...
# 1 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
...
# 2 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
...
# 3 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
...
# 4 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
...
# 5 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
...
# 6 "c:\\users\\user\\documents\\webtours_scripts\\uc6_deletebooking(new)\\\\combined_UC6_DeleteBooking(new).c" 2
